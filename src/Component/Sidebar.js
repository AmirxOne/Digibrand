                    ...
                    <div className='mt-4'>
                        <div className='flex items-center justify-between w-full hover:bg-orange-100 rounded-lg px-2'>
                            <div className='flex items-center'>
                                ...
                                <span className='ml-1 mt-1 leading-10 text-base font-medium text-slate-800'>Product Brand</span>
                            </div>
                        ...
                        <div className='w-full py-3'>
                            <label className='hover:bg-slate-100 flex w-full py-2 items-center justify-start px-3 rounded-lg mb-1'>
                     ...
                     <div className='mt-4'>
                        <div className='flex items-center justify-between w-full hover:bg-orange-100 rounded-lg px-2'>
                            <div className='flex items-center'>
                                ...
                                <span className='ml-1 mt-1 leading-10 text-base font-medium text-slate-800'>Price Range</span>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 stroke-slate-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
                            </svg>
