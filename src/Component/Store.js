...
const Store = () => {
    ...
    const {text, setText} = useContext(serchContext);
        ...
        <>
            {
                products.length !== 0 ?
                    <div className='grid col-span-12 md:col-span-8 md:pr-2 mid:col-span-9 xl:col-span-10 xlup:col-span-10'>
                     ...
                     :
                    <div className='grid col-span-12 md:col-span-8 md:pr-2 mid:col-span-9 xl:col-span-10 xlup:col-span-10 justify-center relative top-[250px] '>          
                        <svg role="status" class="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-300 fill-orange-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
